  ...
  return (
    <header className="sticky top-0 z-40 border-b border-[#dce5e1] bg-[rgba(251,252,251,.9)] backdrop-blur-xl">
      <div className="page-shell flex h-16 items-center justify-between">
        <Link href="/projects" className="flex items-center gap-3" aria-label="PacePM 프로젝트 목록">
          <span className="grid size-9 place-items-center rounded-xl bg-[#166a58] text-sm font-black text-white shadow-sm">P</span>
          <span>
            <span className="block text-[15px] font-black tracking-[-.02em]">PacePM</span>
            <span className="block text-[10px] font-bold tracking-[.12em] text-[#72817d]">PROJECT PACE MANAGER</span>
          </span>
        </Link>
