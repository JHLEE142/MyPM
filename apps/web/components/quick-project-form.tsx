  ...
  return (
    <form onSubmit={submit} className="panel mx-auto max-w-xl p-5 sm:p-8">
      ...
      <div className="space-y-5">
        <label><span className="label">프로젝트 이름</span><input className="field" value={name} onChange={(event) => setName(event.target.value)} maxLength={255} placeholder="예: PacePM 베타 출시" autoFocus /></label>
